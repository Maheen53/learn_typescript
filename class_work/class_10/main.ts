...
// functons with parameter
  function myNewstuffintro(name:string, country:string,job:string):void {
...
/// functions parameter with defult value
  function myNewstuffintro2(name:string, country:string = "pakistan",job:string):void {
    console.log("hi My name is "  + name);
    console.log("I am from " + country);
    console.log(`i am a ${job}`);
  ...
  function myNewstuffintro3(name:string, country:string ,job ?:string):void {
    console.log("hi My name is "  + name);
    console.log("I am from " + country);
    console.log(`i am a ${job}`);
  ...
  function cupTogram(cups:number):number {
    return cups * 250
  }
